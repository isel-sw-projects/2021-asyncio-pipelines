...
using lookwords.SyncSourceStrategies.CountWords.AsyncEnum;
using lookwords.SyncSourceStrategies.BiggestWordFileReadStrategies.AsyncEnum;
using lookwords.SyncSourceStrategies.BiggestWordFileReadStrategies.RxNet;
using lookwords.SyncSourceStrategies.CountWords.RxNet;
using System;
...
{
    public class BenchmarkIOStrategiesWithSyncSourceOnly 
    {
        ...
        public BenchmarkIOStrategiesWithSyncSourceOnly(string folderPath = null)
        {
            if (folderPath != null)
            {
        ...
        public ConcurrentDictionary<string, int> RunAsyncEnumerableTest()
        {
            ...
            Console.WriteLine(@"Count all words RunAsyncEnumerableTest (SYNC SOURCE) took: {0} miliseconds", elapsed);
        ...
        public string RunGetBiggestWordAsyncEnumerableTest()
        {
            ...
            Console.WriteLine(@"Find the biggest word with RunGetBiggestWordAsyncEnumerableTest (SYNC SOURCE) took: {0} seconds", elapsed);
            //
            // Each benchmark should return a value to ensure the VM optimizations
            // wil not discard the call to our operation, i.e. folderWordOccurrencesInSizeRangeWithRX
            //
        ...
        public string RunGetBiggestWordRxTest()
        {
            ...
            Console.WriteLine(@"Find the biggest word with RunGetBiggestWordRxTest (SYNC SOURCE) took: {0} seconds", elapsed);
