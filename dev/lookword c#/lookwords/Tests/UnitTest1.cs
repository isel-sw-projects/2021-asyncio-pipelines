...
#pragma warning restore CS8600 // Conversão de literal nula ou possível valor nulo em tipo não anulável.
            ...
            Assert.AreEqual(ret["test1"], 25);
            Assert.AreEqual(ret["test"], 10);
            Assert.AreEqual(ret["test2"], 20);
            Assert.AreEqual(ret["1"], 1);
            Assert.AreEqual(ret["2"], 2);
            Assert.AreEqual(ret["3"], 3);
            Assert.AreEqual(ret["4"], 4);
            Assert.AreEqual(ret["5"], 5);
            Assert.AreEqual(ret["6"], 6);
            Assert.AreEqual(ret["7"], 7);
            Assert.AreEqual(ret["8"], 8);
            Assert.AreEqual(ret["9"], 9);
