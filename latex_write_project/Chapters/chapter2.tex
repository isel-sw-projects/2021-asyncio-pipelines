...
\begin{table}[!htbp]
	...
	\hline
										  & \textbf{Pull} & \textbf{Push} & \multicolumn{1}{l|}{\textbf{Cancelable}} & \multicolumn{1}{l|}{\textbf{Error Handling}} & \multicolumn{1}{l|}{\textbf{BackPressure}} & \multicolumn{1}{l|}{\textbf{Intrisic words}} \\ \hline
	\textbf{RxJava}                       &               & x             & x                                        & x                                            & x                                          &                                              \\ \hline
	\textbf{Kolin Flow}                   &               & x             & x                                        & x                                            & x                                          &                                              \\ \hline
	\textbf{Javascript for await..of}     & x             &               & x                                        & x                                            & Not applicable                             & x                                            \\ \hline
	\textbf{C\# asynchronous enumerables} & x             &               & x                                        & x                                            & Not applicable                             & x                                            \\ \hline
	\end{tabular}
\end{table}