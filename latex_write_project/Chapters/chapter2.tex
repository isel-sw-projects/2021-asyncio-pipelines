...
As we can see in the example, although the operations and the emission of items being asynchronous, thanks to the the IAsynEnumerable and the use of the 
intrisic words the code is very similar to a synchronous code.
