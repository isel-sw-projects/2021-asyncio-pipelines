...
To achieve these properties, the authors propose the \textit{Proactor Pattern}. In their opinion, conventional concurrency models fail to fully achieve the enumerated properties while this model is a most robust solution in their eyes.
...
\label{csenums}
	...
	%&//colocar exemplo explicar melhor
...
\label{jsae}
	...
	\begin{figure}[H]
		\centering
		\lstfromfile{java}{1-30}{}{asyncenumerables_2}{showlines=true,morekeywords={begin,Console,async,await,static,for, of},numbers=left, firstnumber=1}{asyncenum.js}
