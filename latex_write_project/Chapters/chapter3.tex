...
\begin{figure}[H]
    ...
    symbolic x coords={synchronous Baseline, Parallel, Baseline NIO, Linq synchronous, Non blocking IO using Enumerable, RxJava Blocking, RxJava NIO},
    xtick=data,
    xticklabel style={rotate=45,anchor=east},
    nodes near coords,
    nodes near coords align={vertical},
    ]
    \addplot coordinates {(synchronous Baseline, 15.8) (Parallel, 1.6) (Baseline NIO, 2.8) (Linq synchronous, 22.2) (Non blocking IO using Enumerable, 30) (RxJava Blocking, 23) (RxJava NIO, 15)};
    \end{axis}
    \end{tikzpicture}
    \caption{Processing times for different strategies for "Find the biggest word".}
